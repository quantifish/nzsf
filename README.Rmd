...
The `nzsf` package includes many different shapefiles as data. Shapefiles contained in `nzsf` include New Zealand  Quota Management Area (QMA) boundaries for many finfish and shellfish stocks including:
