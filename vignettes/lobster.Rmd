...
ggplot() +
  ...
  plot_qma(qma = "CRA", fill = NA, colour = "black") +
  plot_statistical_areas(area = "CRA", fill = NA, colour = "grey") +
  plot_coast(resolution = "med", fill = "forestgreen", colour = "forestgreen", size = 0.3) +
...
p
ggsave(filename = "CRA1.png", plot = p, width = 7, height = 6)
```
